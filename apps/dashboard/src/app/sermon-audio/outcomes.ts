...
export const OUTCOMES: Record<string, SpokenOutcome> = {
  ...
  edited: { text: copy.sermonAudio.outcome.edited, bad: false },
  synced: { text: copy.sermonAudio.outcome.synced, bad: true },
  invalid: { text: copy.sermonAudio.outcome.invalid, bad: true },
