...
export default async function ReportsPage({
  ...
  // The requests used to ride along here for the rail count only. The `(dashboard)` layout
  // owns that badge since W4.12 slice 4, so this page reads the inbox and nothing else.
  const inbox = await loadReportsInbox(supabase);
  const scope =
