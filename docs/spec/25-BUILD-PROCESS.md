...
**W3.6 · Phase 3 exit audit** · **notification half COMPLETE 2026-08-30; audio half OPEN**
...
- **What is still open:** the audio-while-driving field test, blocked on having a sermon MP3 at all, since production carries no sermon audio by deliberate policy. One defect was found and deferred: issue #213, a pending milestone modal drawn over a notification's deep-link destination.
