...
keeps a real calendar, planned 2026-09-14), whose slice 1 (the database) and slice 2 (the frames,
approved) are done, so its slice 3 (the app) is the next thing to pick up. Past
