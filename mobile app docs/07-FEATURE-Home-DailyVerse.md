...
- **"I'm here" while browsing another branch** records attendance AT the browsed branch (real visits happen: diaspora members travel); streaks count attendance at any branch, computed in the home branch's timezone (`10`).
